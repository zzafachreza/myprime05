...
export default function FhPolosConfig({navigation}) {
  ...
  const generateScript = () => {
    ...
    // Generate script konfigurasi FH POLOS
    const script = `
configure terminal
...
dhcp
  ...
  const shareScript = async () => {
    try {
      await Share.open({
        ...
        title: 'Konfigurasi FH POLOS ONT'
      });
    } catch (error) {
  ...
  return (
    <View style={styles.container}>
      <MyHeader title="FH POLOS Config" onPress={() => navigation.goBack()}/>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.contentContainer}>
          {!showResult ? (
            ...
            <>
              <Text style={styles.resultTitle}>Hasil Konfigurasi FH POLOS:</Text>
